...
var _secret = _interopRequireDefault(require("secret.json"));
...
var SimpleAPICall = /*#__PURE__*/function () {
  /**
   ...
   */
  function SimpleAPICall(accessToken) {
    _classCallCheck(this, SimpleAPICall);
   ...
   */
  _createClass(SimpleAPICall, [{
    key: "send",
    value: function () {
      var _send = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(route) {
        var headers, callUrl, method;
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            ...
            case 2:
              ...
              callUrl = this.baseURL + route;
              method = 'GET';
              return _context.abrupt("return", (0, _axios["default"])(callUrl, {
                method: method,
                headers: headers
...
var TheOneAPISDK = /*#__PURE__*/function () {
  /**
   * Create a TheOneAPISDK for making API calls.
   */
  function TheOneAPISDK() {
    _classCallCheck(this, TheOneAPISDK);
    this.api = new SimpleAPICall(_secret["default"].accessKey);
  }
